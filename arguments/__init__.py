...
class ModelParams(ParamGroup):
    def __init__(self, parser, sentinel=False):
        ...
        self.lambda_reg_structure = 10
        self.lambda_separation = 0.000001
        self.w_rot = 1.0
        self.w_trans = 1.0
        self.use_voxelized_joints_init = True
        self.soft_init_sigma = 2.0  
        self.soft_init_scale = 3.0  
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.lambda_normal = 0.15
        self.opacity_cull = 0.05

        self.deform_lr_scale = 1.
        self.cd_loss_weight = 100
        self.rotation_loss_weight = 0.5
