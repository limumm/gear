...
for s in scenes:
    ...
    input_dir = f'outputs/{dataset}/{subset}/{s}/train/ours_30000'
    ...
    export_urdf(input_dir, output_scene, s, larger_motion_state[s])
print('done')