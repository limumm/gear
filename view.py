...
def view(dataset, pipe, iteration, state):
    gaussians = GaussianModel(dataset.sh_degree)
    scene = Scene(dataset, gaussians=gaussians, load_iteration=iteration)
...
if __name__ == "__main__":
    ...
    view(lp.extract(args), pp.extract(args), args.iteration, args.state)
